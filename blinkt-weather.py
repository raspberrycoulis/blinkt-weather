...
def getWeather():
    ...
    url = requests.get('https://query.yahooapis.com/v1/public/yql?q=select item.forecast from weather.forecast where u="c" AND woeid=27143569&format=json')
    global weather
    ...
    #print "Today's high temperature is", int(today_high)
    #print "Today's low temperature is", int(today_low)
    #print "Tomorrow's code is", int(next_forecast)
    #print "Next high temperature is", int(next_high)
    #print "Next low temperature is", int(next_low)
